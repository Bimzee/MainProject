...
\begin{table}[H]
	\begin{center}
		...
		\scalebox{0.7}{
		\begin{tabular}{|p{.95cm} | p{5cm} | p{2.75cm}| p{2.75cm} | }%  {|c|c|c|}
			...
			\hline 6 & An Empirical Analysis of Input Validation Mechanisms & Programming Language Efficiency & Type System and Type Checking \\
			\hline 7 & Preliminary Results on Using Static Analysis Tools for Software Inspection  & Source Code Analysis & Coding Standard \\ 
			\hline 8 & Semi-Automatic Security Testing of  Web
...
%		\item Monitoring communication correlation between HTTP and SQL will not detect these issues.\newline
